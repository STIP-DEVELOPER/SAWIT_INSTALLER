...
const findAllModule = async (req, res) => {
    const { error: validationError, value: queryParams } = (0, requestHandler_1.validateRequest)(moduleSchema_1.findAllModuleSchema, req.query);
    if (validationError)
    ...
    try {
        ...
        const dateFilter = startDate && endDate
            ...
            : {};
        const result = await moduleModel_1.ModuleModel.findAndCountAll({
            where: {
                deleted: false,
                ...(search && {
        ...
        logs_1.default.info('Module Result retrieved successfully');
