...
const removeModule = async (req, res) => {
    const { error: validationError, value: queryParams } = (0, requestHandler_1.validateRequest)(moduleSchema_1.deleteModuleSchema, req.params);
    if (validationError)
    ...
    try {
        ...
        logs_1.default.info('Module result deleted successfully');
